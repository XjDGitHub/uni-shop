<template>
	<view>
		...
		<view class="address-choose-box" v-if="JSON.stringify(address)==='{}'">
			<button type="primary" size="mini" calss='btnChooseAddress' @click="chooseAddress">请选择收货地址+</button>
		</view>
		<!-- 渲染收获信息的盒子 -->
...
<script>
	...
	export default {
		...
		methods: {
			...mapMutations('m_user', ['updatAddress', 'saveAddressToStorage']),
			// 选择收货地址
			async chooseAddress() {
